...
template <int MAX_K>
inline void KCASHTM<MAX_K>::writeInitPtr(casword_t volatile *addr, casword_t const newval) {
    *addr = newval;
}

template <int MAX_K>
inline void KCASHTM<MAX_K>::writeInitVal(casword_t volatile *addr, casword_t const newval) {
    writeInitPtr(addr, newval << KCAS_LEFTSHIFT);
}

template <int MAX_K>
bool KCASHTM<MAX_K>::start() {
...
template <int MAX_K>
inline kcasptr_t KCASHTM<MAX_K>::getDescriptor() {
