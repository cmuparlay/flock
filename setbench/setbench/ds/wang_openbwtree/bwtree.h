...
class BwTreeBase {
  ...
  class PaddedData {
   public:
    ...
    static constexpr size_t PD_ALIGNMENT = Alignment;
   ...
   private:
    char padding[PD_ALIGNMENT - sizeof(DataType)];
  };

  using PaddedGCMetadata = PaddedData<GCMetaData, CACHE_LINE_SIZE>;

  static_assert(sizeof(PaddedGCMetadata) == PaddedGCMetadata::PD_ALIGNMENT,
